...
<template>
    <div class="mx-32">
        <h6 class="mt-8">Create a New Vacancy</h6>
        <form @submit.prevent="submit">
            <div class="flex flex-col mt-16 my-4">
                <label for="title" class="text-gray-500">Job Title:</label>
            ...
            <div class="flex my-4">
                <div class="w-1/2 flex flex-col">
                    <label for="mode" class="text-gray-500">Mode:</label>
            ...
            <div class="flex flex-col my-4">
                <label for="salary" class="text-gray-500">Salary:</label>
            ...
            <div class="flex flex-col my-4">
                <label for="location" class="text-gray-500">Location:</label>
            ...
            <div class="flex flex-col my-4">
                <label for="description" class="text-gray-500">Job Description:</label>
            ...
            <button type="submit" class="my-4 bg-blue-500 text-white rounded-md px-4 py-2 cursor-pointer">Submit</button>
        </form>
    </div>
</template>
